//The program is used by Green Fields Landscaping to
...
int main()
{
	...
	double treeCost, //Cost of particular tree
		totalTreeCost, //Total price for all the trees
		deliveryCost = 0.0, //Delivery cost for all trees
	...
	//else planted and delivery costs both remain 0.0
